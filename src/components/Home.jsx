      ...
      <header className="bg-white shadow">
        <div className="container mx-auto px-4 sm:px-6 py-4 flex flex-col sm:flex-row justify-between items-center">
          ...
          <nav
            ...
            } sm:flex sm:items-center sm:space-x-6 mt-4 sm:mt-0 w-full sm:w-auto`}
          >
            {["home", "features", "pricing", "resources"].map((section) => (
              <a
                ...
                className={`block sm:inline-block text-sm sm:text-base text-center py-2 sm:py-0 ${
                  active === section
              ...
              >
                ...
                {active === section && <span className="text-blue-500">*</span>}
              </a>
            ))}
          </nav>
          ...
          <a
            href="#contact"
            className="bg-gradient-to-r from-[#1F67E7] to-[#1AD7BE] text-white text-sm px-4 py-2 rounded-full shadow-md hover:opacity-90 mt-4 sm:mt-0 w-full sm:w-auto text-center"
          >
            Contact Us
          </a>
        </div>
